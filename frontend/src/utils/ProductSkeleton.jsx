...
function ProductSkeleton() {
    ...
    return (
        <div className={`${isDark? "bg-[#171A2E]  border-2 shadow shadow-[#00000040] border-[#2A2E5A]":"bg-white"} max-w-sm rounded-xl shadow-lg p-2 animate-pulse animate-easeIn transform-gpu`}>
