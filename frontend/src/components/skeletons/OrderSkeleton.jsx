          ...
          <tr>
            ...
            <td className="px-4 py-4 w-1 sm:w-1/2 lg:pl-10 pl-0">
              <div className="flex flex-row items-center gap-3">
                <div className={`h-20 min-w-20 rounded ${bg}`}></div>
                <div className="flex flex-col gap-2">
                  <div className={`h-4 sm:w-40 w-35 rounded ${bg}`}></div>
            ...
            {/* Amount */}
            <td className="px-4 py-4 w-1/6 sm:table-cell hidden">
            ...
            <td className="sm:hidden w-1/10">
              <div className={`h-3 w-10 rounded ${bgLight}`}></div>
            </td>
          </tr>
        </tbody>
      </table>
