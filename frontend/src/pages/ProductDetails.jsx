...
function ProductDetails() {
    ...
    return (
        <div className={`flex flex-col gap-2 md:p-5 min-h-screen w-full pb-20 ${!isDark ? "bgImg" : "darkBgImg"}`}>
            {loading ?
                (
                    <ProductDetailsSkeleton />
                ) : (
                    <div className={`md:rounded-4xl md:p-2 animate-easeIn ${!isDark ? "bg-[#FFFFFF95]" : "bg-[#0F172A95]"}`}>
