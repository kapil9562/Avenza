...
function ProductDetails() {
    ...
    return (
        <div className={`flex flex-col gap-2 sm:px-5 lg:px-10 px-2 py-2 md:py-5 lg:min-h-[calc(100dvh-112px)] md:min-h-[calc(100dvh-80px)] min-h-[calc(100dvh-112px)] w-full relative ${isDark ? "bg-[#0F172A]" : "bg-[#FFFFFF]"}`}>
            ...
            {loading ?
                (
                    ...
                    !product ? (
                        <div className="absolute top-1/2 left-1/2 -translate-y-1/2 -translate-x-1/2 flex flex-col h-fit w-fit justify-center items-center gap-4 px-4 text-center">
                        ...
                        <>
                            <div className="flex flex-col md:flex-row gap-2 sm:gap-8 p-2 w-full">
                                {/* IMAGE SECTION */}
                                <div className="flex gap-3 sm:gap-5 md:gap-3 justify-start items-start flex-col sm:flex-row md:flex-col">

                                    {/* Main Image */}
                                    <div className={`relative w-full md:w-80 lg:w-120 xl:w-150 h-70 lg:h-120 md:h-80 sm:h-100 flex items-center justify-center rounded-2xl ${isDark && "shadow-lg shadow-[#0F172A] border border-gray-800"}`} style={{
                                    ...
                                    {/* Thumbnails */}
                                    <div className="flex gap-4 flex-row sm:flex-col md:flex-row">
                                        {product?.images?.map((img, idx) => (
                                            <button
                                                ...
                                                className={`border-2 rounded-xl overflow-hidden border-gray-200 cursor-pointer ${currentImg === img
                                                    && "border-pink-500"
                                ...
                                <div className="flex flex-col gap-4">
                                    <div className="md:px-2">
                                        <h1 className={`${!isDark ? "text-[#454545]" : "text-[#F564A9]"} font-medium md:text-3xl text-2xl`}>
                                            {product.title}
                                        </h1>

                                        <p className={`${!isDark ? "text-[#787878]" : "text-gray-300"} mt-2 text-sm sm:text-[16px]`}>
                                            {product.description}
                                        </p>

                                        <div className="flex flex-row md:gap-4 gap-2 justify-center items-center w-fit md:mt-4 mt-2">
                                        ...
                                        {product?.stock > 0 ? (
                                            <div className="flex flex-col md:flex-row gap-4 md:mt-6 mt-2">
                            ...
                            <div className="w-full px-2 md:p-4 h-1">
                                <div className={`w-full h-px ${!isDark ? "bg-gray-200" : "bg-gray-700"}`}></div>
                            </div>
                            <div className="pb-4 flex flex-col gap-4 md:px-6 px-2 w-full">
                                <h1 className={`text-lg mb-2 font-semibold ${!isDark ? "text-gray-800" : "text-gray-200"}`}>
                                    Customer Reviews
                                </h1>
                            ...
                            <div className="pb-4 flex flex-col w-full">
                                <h1 className={`md:text-2xl text-lg font-semibold mb-2 sm:pl-6 px-2 ${!isDark ? "text-gray-800" : "text-gray-200"}`}>
                                    Related Products
                                </h1>
